	...
	else 
	{
		...
		echo "<table>";
			echo "<tr>";
				...
				echo "<td width='250px' >Hình ảnh</td>";
			...
			for($i=0;$i<count($_SESSION['id_them_vao_gio']);$i++)
			{
				...
				$sql="select id,ten,gia,hinh_anh from san_pham where id='".$_SESSION['id_them_vao_gio'][$i]."'";
				$tam=$conn->query($sql);
				$data=$tam->fetch();
				...
				$name_id="id_".$i;
				$name_sl="sl_".$i;
				if($_SESSION['sl_them_vao_gio'][$i]!=0|| $_SESSION['sl_them_vao_gio'][$i]>0)
				{
				echo "<tr>";
					echo "<td>".$data['ten']."</td>";
					echo "<td>";
					...
					echo "<th>";
						echo "<td width='250px'>";
					echo"</th>";
					echo "<img src='$link_anh' width='150px' align='center'>";
